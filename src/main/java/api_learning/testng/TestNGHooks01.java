...
//        softAssert.assertEquals("actualResult_", "expectedResult_", "[ERR] Loi roi Ti oi");
        ...
        //softAssert se luon pass neu khong co softAssert.assertAll() de in ra cac loi trong test do
        //Chi dung khi muon chay 1 list test ma k muon dung khi co loi. Den cuoi se thong ke cac loi gap fai
