...
public class LoginFormComponent {
    ...
    private final static By correctTitleSel = MobileBy.id("android:id/alertTitle");
    ...
    public String getValidTitleStr(){
        return  appiumDriver.findElement(correctTitleSel).getText();
    }
}