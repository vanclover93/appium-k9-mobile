...
public class HandleMultipleApps {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Toggle ON/OFF
            By wifiStatusSel = MobileBy.xpath("//*[@text='AndroidWifi']");
            MobileElement switchWifiElem = appiumDriver.findElement(MobileBy.AccessibilityId("Wi‑Fi"));
            MobileElement wifiStatusElem = appiumDriver.findElement(wifiStatusSel);
            String wifiStatusStr = wifiStatusElem.getText().trim();
            boolean isWifiOn = wifiStatusStr.equalsIgnoreCase("AndroidWifi");
            if(isWifiOn) switchWifiElem.click();
